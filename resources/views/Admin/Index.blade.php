      ...
      <div class="navbar navbar-fixed-top scroll-hide">
        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              <li>
                <a class="@yield('indexcurrent')" href="{{ url('back') }}"><span aria-hidden="true" class="se7en-home"></span>Dashboard</a>
              </li>
              ...
              <li class="dropdown"><a class="@yield('Tablescurrent')" data-toggle="dropdown" href="#">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="{{ url('back/datatables') }}">DataTables</a>
                  </li>
          ...
          <div class="col-md-6">
            <div class="widget-container scrollable chat" style="height: 427px;">
              ...
              <div class="widget-content padded">
                <ul>
                  <li>
                    <img width="30" height="30" src="../resources/Admin/images/avatar-male.jpg" />
                    <div class="bubble">
                  ...
                  <li class="current-user">
                    <img width="30" height="30" src="../resources/Admin/images/avatar-female.jpg" />
                    <div class="bubble">
